...
# source: https://raw.githubusercontent.com/cernops/nova-quota-sync/master/nova-quota-sync
...
def main():
    ...
    DB_DATABASE = os.environ.get("DB_DATABASE", "nova")
    DB_HOST = os.environ.get("DB_HOST", "localhost")
    DB_PASSWORD = os.environ.get("DB_PASSWORD", "password")
    DB_PORT = os.environ.get("DB_PORT", "3306")
    DB_USERNAME = os.environ.get("DB_USERNAME", "nova")

    db_url = "mysql+pymysql://%s:%s@%s:%d/%s" % (DB_USERNAME, DB_PASSWORD, DB_HOST, int(DB_PORT), DB_DATABASE)
